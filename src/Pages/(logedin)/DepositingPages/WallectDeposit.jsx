...
export default function DepositeFunds() {
  ...
  const { userdata, useraccount, supportData } = useData();
  ...
  return (
    <>
      ...
      <main className="kyc-form-holder">
       {showprocess && (
         <PaymentProcessingModal open={showprocess} />
       )}
        {step == 1 ? (
          <>
            ...
            >
              <FormSelect
                ...
                labelText="Select account to topup"
              ...
              <div className="note-info">
                ...
                <p>
                  The account selected will be toped up in the account currency{" "}
                  <Link>Lern More</Link>
                </p>
              </div>
              <FormInput
          ...
          <>
            ...
            >
              ...
              <p>
                Scan qrcode or copy wallect address to deposite crypto worth the{" "}
                {code}
                {amount} click confirm payment to have the payment processed,
                Thank your
              </p>
            </div>
            ...
            <div className="crypto-payment">
                {defualtPayment && (
                    ...
                    <div>
                        <span>
                            <small>Name: {defualtPayment.coinName}</small>
                            <span onClick={() => copyWalletAddress(defualtPayment.coinName)}><Icon name="LuCopy" /></span>
                        </span>
                        <span>
                            <small>Network: {defualtPayment.tokenNetwork}</small>
