...
export default function PersonalDetails() {
  ...
  return <main className="dashboard-main-content account-dashboard">
      <h2> <BackButton />{t("profile")}</h2>
      <p>{t("view_and_update_profile_details")}</p>

      <div className="pinfo">
        <div className="cover-proimage">
          {previewImage ? <CustomImage source={previewImage} alt="Preview" /> : userdata?.avatarUrl ? <CustomImage source={`${MediaUrl}${userdata.avatarUrl}`} /> : userdata?.first_name && userdata?.last_name ? <span className="profile-text">
