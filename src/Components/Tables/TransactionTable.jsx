...
export default function TransactionTable({
  ...
  return <section className="table-holder-section" style={{
    width: "fit-content",
    minWidth: "100%",
    overflowX: "scroll"
  }}>
             <TransactionPopCard className="transaction-card" isopen={showdetail} amount={Number(details.amount) || 0} code={details.currencySign} date={details.date} account={details.accountNumber} type={details.type} status={details.status} description={details.description} id={details.id} currency={details.currency} onclose={() => {
      setShowdetail(false);
    }} />
