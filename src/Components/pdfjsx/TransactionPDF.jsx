    ...
    <Document>
      ...
      >
        <View style={styles.container}>
          ...
          <Text style={{ color: "#fff", fontSize: 28, width: "35%", fontWeight: "500" }}>
            Transaction Reciept
          </Text>
          <View style={styles.logo}>
            <Image style={{ width: 30, height: 30 }} source={icon} />
            <Text style={{fontSize: 20, fontWeight: 500}}>Leadbank</Text>
          </View>
        </View>
        </View>
