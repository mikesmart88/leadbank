...
const Row = ({ label, value, stripe = false, status = false }) => (
  <View style={[styles.row, stripe && styles.alternateRow]}>
    <Text style={styles.label}>{label}</Text>

    <Text style={[styles.value, status && getStatusStyle(value)]}>{value}</Text>
  </View>
);
        ...
        <View style={styles.container}>
          ...
          <View style={styles.body}>
              ...
              <View style={styles.table}>
                ...
                {transaction.type == "withdraw" ? (
                  <Row
                    ...
                    value={formatMoney(0.2, transaction.currency)}
                  />
                ) : null}
                ...
                <Row
                  ...
                  stripe={transaction.type !== "withdraw"}
                />
            ...
            <View style={styles.footer}>
              ...
              <Text style={styles.support}>support@leadbankuniversalcom</Text>
            </View>
          </View>
        </View>
      </Page>
