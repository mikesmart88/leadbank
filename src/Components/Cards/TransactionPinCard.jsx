...
export default function TransactionPinModal({
  ...
  return (
    <div className="verification-overlay card-overlay pin-overlay">
      <div className="pin-modal card-details-show">
        <h3>Enter Transaction PIN</h3>
        <p>Please enter your 4-digit transaction PIN.</p>
        ...
        <div className="mobile-keypad">
          ...
          <CustomButton type="button" onClick={() => addDigit("0")}>
            0
          </CustomButton>
        </div>
